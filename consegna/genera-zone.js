...
const PIN = {
  ...
  'fornitore-pesce-la-spezia':     { fx: 0.299, fy: 0.606, bx: 0.283, by: 0.575, bw: 0.150, bh: 0.070 },
  'fornitore-pesce-massa-carrara': { fx: 0.448, fy: 0.654, bx: 0.432, by: 0.623, bw: 0.120, bh: 0.070 },
  'fornitore-pesce-versilia':      { fx: 0.520, fy: 0.808, bx: 0.504, by: 0.777, bw: 0.080, bh: 0.070 },
  ...
  'fornitore-pesce-firenze':       { fx: 0.869, fy: 0.925, bx: 0.853, by: 0.894, bw: 0.078, bh: 0.070 },
};
...
${piede(['../js/caustiche.js?v=1', '../js/pesci.js?v=11', '../catalogo/js/d.js?v=1', 'js/mappa.js?v=1', '../js/cursore.js?v=2'], { cat: '../catalogo/' })}`;
}
